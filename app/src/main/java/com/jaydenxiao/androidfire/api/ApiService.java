...
public interface ApiService {
    ...
    @POST("/account/register") // 需要手机验证码
    Observable<BaseRep<User>> register(@Body RegisterReq registerReq);

    @POST("/account/verify") // 获取手机验证码
    ...
    Observable<Map<String, NewsDetail>> getNewDetail(
            @Header("cacheUser-Control") String cacheControl,
